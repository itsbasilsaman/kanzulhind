...
const ProductSection = ({ products, category }: ProductSectionProps) => {
              ...
              <div className="w-dyn-list">
                <div role="list" className="w-dyn-items product-grid">
                  {products.map((product) => (
                    <a
                      key={product.id}
                      href={`https://wa.me/918075347955?text=${encodeURIComponent(`Hi, I'm interested in the ${product.name}. Could you please share more details for enquiry?\n`)}`}
                      target="_blank"
